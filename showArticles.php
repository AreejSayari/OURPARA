        ...
        <div class="registration-form">
            <div class="container">
                ...
                <table class="table table-striped">
                    ...
                    $reqprep = $idcom->prepare("SELECT * FROM article");
                    $reqprep->execute();
                    echo "<tbody>";
                    while ($row = $reqprep->fetch(PDO::FETCH_NUM)) {
                        ...
                        echo "<td>", $row[3], "</td>";
                        echo "<td>", $row[4], "</td>";
                        echo "<td><img src= '" . $row[6] . " ' width=100px heigth=100px/></td>";
                        echo "<td>", $row[5], "</td>";
                        echo "<td><a href='editArticle.php?id=" . $row[0] . "'>Edit</a></td>";
                        echo "<td><a onclick='javascript:confirmationDelete($(this));
								return false;' href='deleteArticle.php?id=" . $row[0] . "'>Delete</a></td><tr>";
                        echo "</tr>";
