			...
			<div class="container">
				...
				<div class="header-right">
					<div class="cart box_1">
						<a href="checkout.php">
							<h3> <span class="simpleCart_total"> 0 DT </span>
				...
				<div class="cart-header">
					<table class="table table-striped" width=100%>
						...
						if (empty($ids)) {
							...
							$req = $idcom->prepare("select * from article where id_article IN (" . implode(',', $ids) . ")");
							...
							while ($product = $req->fetch(PDO::FETCH_ASSOC)) {
								...
								<tr>
									...
									<td><a href="checkout.php?del=<?= $product['id_article'] ?>"><img
												src="images/close_1.png"></a></td>
								</tr>
					...
					<div class="news-letter">
						<div class="container">
							<div class="join">
								<h6>Total : <?= $total ?>DT </h6>
								<div class="sub-left-right">

									<input type="submit" value="Confirm order" class="simpleCart_empty"
										href="javascript:;" onclick="window.location.href = 'valider_panier.php' ;" />
